...
import { errorMonitoring, logger } from '@/lib/monitoring';
...
// Mock monitoring hook for browser compatibility
const useMonitoring = () => ({
  ...
  recordMetric: (metric: any) => {
    logger.info('Recording metric', metric);
  },
});
...
export default function SecurityDashboard() {
  ...
  const loadSecurityData = async () => {
    try {
      ...
      const complianceScore = complianceChecks.length > 0 ? (compliantChecks / complianceChecks.length) * 100 : 95;
